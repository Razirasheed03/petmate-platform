...
const sendResetPasswordLink = (to, subject, resetUrl // Change this to accept just the URL
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Hello,</p>
        <p>We received a request to reset your password for your Petmate account.</p>
        ...
        <p style="color: #888; font-size: 12px;">
          This is an automated message from Petmate. Please do not reply to this email.
        </p>
      </div>
    `,
      ...
      We received a request to reset your password for your Petmate account.
