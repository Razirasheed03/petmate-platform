...
class AuthService {
    constructor(_userRepo) {
        ...
        this.verifyOtp = (email, otp) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (role === "doctor") {
                const doctor = yield doctor_model_1.DoctorModel.findOne({ userId: createdUser._id });
                doctorId = (_a = doctor === null || doctor === void 0 ? void 0 : doctor._id) === null || _a === void 0 ? void 0 : _a.toString();
            }
            const accessToken = (0, jwt_1.generateAccessToken)(userId, role, doctorId);
            const refreshToken = (0, jwt_1.generateRefreshToken)(userId);
            // Store refreshToken in Redis for validation/revocation
            yield redisClient_1.default.setEx(`refresh:${userId}`, 7 * 24 * 60 * 60, // 7 days in seconds
            refreshToken);
        ...
        this.login = (email, password) => __awaiter(this, void 0, void 0, function* () {
            ...
            let doctorId = undefined;
            if (role === "doctor") {
                const doctor = yield doctor_schema_1.Doctor.findOne({ userId: user._id }).select("_id");
                doctorId = (_a = doctor === null || doctor === void 0 ? void 0 : doctor._id) === null || _a === void 0 ? void 0 : _a.toString();
            }
        ...
        this.googleLogin = (idToken) => __awaiter(this, void 0, void 0, function* () {
            ...
            let doctorId = undefined;
            if (role === "doctor") {
                const doctor = yield doctor_model_1.DoctorModel.findOne({ userId: user._id });
                doctorId = (_a = doctor === null || doctor === void 0 ? void 0 : doctor._id) === null || _a === void 0 ? void 0 : _a.toString();
            }
            const accessToken = (0, jwt_1.generateAccessToken)(userId, role, doctorId);
            const refreshToken = (0, jwt_1.generateRefreshToken)(userId);
